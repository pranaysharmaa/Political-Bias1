...
#  replacing Windows mounts with their WSL mounts: WSL provides faster runtime for this model's training
...
def load_json_df():
    ...
    if not os.path.isdir(JSON_DIR):
        print(f" Missing JSON folder: {JSON_DIR}")
        return pd.DataFrame(rows)
...
def main():
    ...
    # HuggingFace Dataset and train/test split
